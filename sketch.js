...
path=createSprite(width/2,height/height-200);
...
function draw() {
  ...
  createCash(width,height-45,30,50);
  createDiamonds(width,height-45,30,50);
  createJwellery(width,height-45,30,50);
  createSword(width,height-45,30,50);
